...
from PyQt5.QtCore import Qt, QTime, QCoreApplication, QEventLoop, QPoint, QTimer
import time
...
def fill_xor(win):
    ...
    win.edges = sort_edges(win.edges)
    delay_val = 3 #int(10 / len(win.edges))
